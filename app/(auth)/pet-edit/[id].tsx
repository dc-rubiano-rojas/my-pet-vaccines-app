...
const PetEdit = () => {
    ...
    useEffect(() => {
        console.log('====================================');
        console.log('PET USE EFFECT EDIT', { petName, petImage });
        console.log('====================================');
        /* const petToEditconst =  pets.filter(p => p.pid === pId.toString())[0]
        setPetToEdit(petToEditconst)
        console.log('====================================');
        console.log(petToEditconst);
